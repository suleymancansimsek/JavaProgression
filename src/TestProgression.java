...
public class TestProgression {
  public static void main(String[] args) {
    ...
    System.out.println("SquareRoot progression with start values 65536: ");
    prog = new SquareRootProgression();
    prog.printProgression(10);
    System.out.println("SquareRoot progression with given start values : "); //given start value
    prog = new SquareRootProgression(Math.pow(2,18));
    prog.printProgression(10);
  }
}
